...
<Callout type="info">
Before exposing a Docker Compose deployment to production traffic, review [Production Hardening](../operations/production-hardening) for server port binding, image pinning, and database exposure guidance.
</Callout>
